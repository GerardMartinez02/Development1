...
#define DEGTOARD 0.0174532925199432957f
...
PhysBody* ModulePhysics::CreateCircle(int x, int y, int radius, int dynamicBody = 0)
{
	b2BodyDef body;
...
PhysBody* ModulePhysics::CreateRectangle(int x, int y, int width, int height, int dynamicBody = 0)
{
	b2BodyDef body;
	switch (dynamicBody)
	{
...
void ModulePhysics::CreateBouncerJoint()
{
	...
	jointDef.bodyA = app->scene->Bouncer->body;
	jointDef.bodyB = app->scene->BouncerPivot->body;
...
PhysBody* ModulePhysics::CreateRectangleSensor(int x, int y, int width, int height,int dynamicBody)
{
	b2BodyDef body;
...
PhysBody* ModulePhysics::CreateEnemyBird(int x, int y, int* points, int size, int dynamic = 0)
{
	// Create BODY at position x,y
	b2BodyDef body;
	switch (dynamic)
...
PhysBody* ModulePhysics::CreateEnemyDragon(int x, int y, int* points, int size, int dynamic = 0)
{
	// Create BODY at position x,y
	b2BodyDef body;
	switch (dynamic)
